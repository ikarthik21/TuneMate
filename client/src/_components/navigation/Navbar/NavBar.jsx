...
const NavBar = ({openModal}) => {
    ...
    return (<nav
        ...
        <div
            className="flex items-center justify-center bg-[#222328] border-[#606064] rounded-full border relative">
            <div className="p-3">
                <FiSearch size={20}/>
            </div>
            <Input
            ...
            />
            {search && (<div className="absolute right-4 p-3 transform hover:scale-110 cursor-pointer"
                             onClick={() => setSearch("")}>
                <IoClose size={20}/>
            </div>)}
        </div>
