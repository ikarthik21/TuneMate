...
userMetaRouter.post(
  ...
  isAuthUser,
  UserMetaController().manageUserFavorites
);

userMetaRouter.get(
  ENDPOINTS.favorites,
  isAuthUser,
  UserMetaController().getFavorites
);

userMetaRouter.post(
  ENDPOINTS.updatePlayerState,
  isAuthUser,
  UserMetaController().updatePlayerState
);

userMetaRouter.post(
  ENDPOINTS.updateSyncState,
  isAuthUser,
  UserMetaController().updateSyncState
);

userMetaRouter.get(
  ENDPOINTS.getPlayerState,
  isAuthUser,
  UserMetaController().getPlayerState
);

userMetaRouter.get(
  ENDPOINTS.getUserSongHistory,
  isAuthUser,
  UserMetaController().getUserSongHistory
);

userMetaRouter.post(
  ENDPOINTS.addSongToHistory,
  isAuthUser,
  UserMetaController().addSongToHistory
);
